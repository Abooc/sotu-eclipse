...
//
//public class UmengTabsFragment extends Fragment implements OnTabChangeListener {
...
//		mRoot = inflater.inflate(R.layout.umeng_example_xp_tabfragment,
//				container, false);
...
//		new ExchangeViewManager(mContext, exchangeDataService1)
//				.addView(vg1, l1);
...
//		((TextView) view1.findViewById(R.id.umeng_example_tab_text))
//				.setText(TAB_APP);
//		View view2 = LayoutInflater.from(mContext).inflate(
//				R.layout.umeng_example_tab_indicator, null);
//		((TextView) view2.findViewById(R.id.umeng_example_tab_text))
//				.setText(TAB_WEB);
//
...
//			mTabWidget
//					.setBackgroundResource(R.drawable.umeng_example_two_tab_left);
//			return;
//		}
//		if (TAB_WEB.equals(tabId)) {
//			mTabWidget
//					.setBackgroundResource(R.drawable.umeng_example_two_tab_right);
//			return;
//		}
//	}
//}