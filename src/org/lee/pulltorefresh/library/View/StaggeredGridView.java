...
package org.lee.pulltorefresh.library.View;
 ...
 * {@link org.lee.pulltorefresh.library.View.StaggeredGridView.LayoutParams}. The attribute <code>android:layout_span</code> may be
			...
			if (mTouchMode == TOUCH_MODE_DOWN) {
				...
				if (child != null && !child.hasFocusable()) {
					...
					if (!mDataChanged) {
						...
						setPressed(true);
						// layoutChildren(true);//长按会闪跳，所以注掉
						positionSelector(mMotionPosition, child);
						refreshDrawableState();
